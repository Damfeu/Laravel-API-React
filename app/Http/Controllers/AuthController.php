...
{
    private AuthIterface $authInterface;
    public function __construct(AuthIterface $authIterface)
    {
        $this->authInterface = $authIterface;
    }
    ...
    public function login(LoginRequest $loginRequest)
    {
        ...
        try {
            ...
            return ApiResponse::sendResponse($user, [], 'Opération effectuée.',  200 );
